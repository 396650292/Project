...
<html>
  <head>
    ...
    <title>My JSP 'money_query.jsp' starting page</title>
  ...
  <%
		...
		if(request.getParameter("name")==null&&request.getParameter("month")==null){
			dataCount=page1.queryCount5();
		}else {
			dataCount=page1.queryCount5BynameOrMonth(name, month);
		}
		//每页数据条数
		int count=5;
		//总页数
		...
		//数组传过去
		ArrayList<Money> list=null;
		if(request.getParameter("name")==null&&request.getParameter("month")==null){
			list=page1.queryByPage5(cp*count,count);		
		}else {
			list=page1.queryByPageBy5(name, month, cp*count, count);
		}
  ...
  <body>
    ...
    <%@include file="index_top.jsp"%>
    			...
    			<table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
					<tr align="center">
						<td>
						<form action="money_query.jsp" method="post">
							<select name="name">
								<% 
							...
							<input type="submit" name="byName" value="按姓名查询"/>
							...
							<input type="submit"  name="byMonth" value="按月份查询"/>
							<a href="money_query.jsp" style="text-decoration: none">查询所有</a>
							</form>
						</td>
					</tr>
					<tr align="center">
